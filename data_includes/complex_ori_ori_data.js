...
PennController("demographics",
               ...
               newText("intro_instructions", "<p>Acest experiment investighează modul în care oamenii procesează informația lingvistică.<p>"
                       +"<p>Descrierea experimentului: Ana și Matei sunt doi prieteni cărora le place să se joace. În acest experiment veți fi martorii unuia dintre jocurile lor. Regulile sunt următoarele: Ana are două imagini. Prima imagine reprezintă o situație și este însoțită de o propoziție care o descrie. A doua imagine reprezintă o scenă ulterioară. Ana îi arată lui Matei prima imagine, cea care descrie situația, și îi cere să ghicească ce se va întâmpla. Mihai ghicește, dupa care Ana îi prezintă a doua imagine cu scena următoare. <b>Sarcina dumneavoastră va fi să judecați dacă Mihai a ghicit corect, apăsând pe butonul 'da' sau 'nu'.</b>.<p>"
               ...
               // .print()
               // ,   
               newText("consent_button", "Prin apăsarea butonului 'Îmi dau acordul', sunteți de acord cu următoarele:<br>"
...
//====================================================================================================================================================================================================================
// 2. Practice trials
PennController.Template( PennController.GetTable( "exp_rom_complex_ori_ori.csv")// change this line for the appropriate experimental list
                         ...
                         variable => PennController( "practice_trials",
                                                     ...
                                                     .print()
                                                     ,
                                                     newButton("next_guess", "Următorul")
                                                     .settings.center()
                                                     .settings.css("font-size", "15px")
                                                     .print()
                                                     .wait()
                                                     ...
                                                     .remove()
                                                     ,
                                                     newButton("next_outcome", "Următorul")
                                                     .settings.center()
                                                     .settings.css("font-size", "15px")
                                                     .print()
                                                     .wait()
...
PennController( "final",
                newText("final_text","<p><b>Vă mulțumim pentru participare!</b><p><br><p>entru a vă valida participarea și a primi plata, faceți clic aici: <a href='https://app.prolific.co/submissions/complete?cc=3028FA29' target='_blank' >Validați participarea</a><p><p>Toate datele și informațiile pe care le colectăm în cadrul acestui experiment sunt tratate în mod confidențial și sunt utilizate numai în scopuri științifice.<p> <p>Dacă aveți întrebări legate de acest studiu, vă rugăm să ne contactați la adresa: <b>cross.conn.dfg@gmail.com</b>.<p>")
                .settings.css("font-size", "20px")
                .settings.center()
                .print()
                ,
